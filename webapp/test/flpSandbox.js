		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tanksoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tanksoperations-display": {
								"semanticObject": "tanksoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tanksoperations",
									"url": sap.ui.require.toUrl("tanksoperations")
								}
							}
						}
					}
